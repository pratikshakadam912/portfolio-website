    ...
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#050505] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-5 py-12 sm:px-8 lg:px-12">
        ...
        <div className="mb-10 flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-3 font-mono text-[9px] tracking-[0.25em] text-neutral-600">
            <span className="text-cyan-400">SYS</span>
            <span>/</span>
            <span>FOOTER</span>
          </div>

          <div className="flex items-center gap-2 font-mono text-[9px] tracking-[0.2em] text-neutral-700">
        ...
        <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          ...
          <div>
            <div className="mb-5 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center border border-white/10 bg-[#080808] font-mono text-xs text-cyan-400">
                PK
              </div>
              ...
              <div>
                ...
                <p className="mt-1 font-mono text-[8px] tracking-[0.2em] text-neutral-600">
                  DIGITAL WORKSPACE
                </p>
              </div>
            </div>

            <p className="max-w-md font-mono text-[10px] leading-6 tracking-[0.08em] text-neutral-600">
          ...
          <div>
            <div className="mb-5 flex items-center gap-2 font-mono text-[9px] tracking-[0.2em] text-neutral-600">
              <Terminal size={12} />
              NAVIGATION
            </div>
            ...
            <div className="flex flex-col items-start gap-3">
              <a
                href="#home"
                className="group flex items-center gap-2 font-mono text-[10px] tracking-[0.15em] text-neutral-500 transition-colors hover:text-cyan-400"
              >
                HOME
                <ArrowUpRight
                  size={11}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="group flex items-center justify-between border-b border-white/5 pb-3 font-mono text-[10px] tracking-[0.15em] text-neutral-500 transition-colors hover:text-cyan-400"
              >
                GITHUB
                <ArrowUpRight
                  size={12}
                  className="text-neutral-700 transition-all group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-cyan-400"
                />
              </a>
        ...
        <div className="mt-12 grid border-y border-white/10 py-5 sm:grid-cols-3">
          <div className="border-b border-white/5 pb-4 sm:border-b-0 sm:border-r sm:pb-0">
          ...
          <div className="border-b border-white/5 py-4 sm:border-b-0 sm:border-r sm:px-6 sm:py-0">
            <p className="font-mono text-[8px] tracking-[0.2em] text-neutral-700">
              STACK
            </p>
        ...
        <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="font-mono text-[9px] tracking-[0.15em] text-neutral-700">
          ...
          <a
            ...
            className="group flex h-10 w-10 items-center justify-center border border-white/10 bg-[#080808] transition-all duration-300 hover:border-cyan-400/50 hover:bg-cyan-400/[0.05]"
          >
            <ArrowUp
              size={15}
              className="text-neutral-500 transition-all group-hover:-translate-y-1 group-hover:text-cyan-400"
            />
          </a>
        </div>
        ...
        <div className="mt-8 flex items-center justify-between font-mono text-[8px] tracking-[0.2em] text-neutral-800">
