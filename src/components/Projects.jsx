...
const projects = [
...

  {
    ...
    desc: "An intelligent resume analyzer that evaluates resumes, extracts key information and provides AI-powered suggestions.",
    tech: ["React", "Python", "Flask", "SQLite", "AI"],
    category: "AI / ML",
    github: "YOUR_GITHUB_LINK",
    live: "YOUR_RENDER_LINK",
    image: resumeImg,
  },
];
...
const Projects = () => {
  return (
    <section
      ...
      px-5 sm:px-8 lg:px-12 py-20 relative overflow-hidden"
    >
      {/* Background Grid */}
...
const Card = ({ proj, index }) => {
  ...
  return (
    <motion.div
      ...
      hover:border-pink-400 dark:hover:border-blue-500/40
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition pointer-events-none">
        <div className="w-full h-full bg-gradient-to-r from-pink-300/20 via-purple-300/20 to-pink-400/20 dark:from-blue-500/20 dark:to-purple-500/20 blur-2xl"></div>
      </div>
      ...
      <div className="p-5 flex flex-col flex-grow">
        <span className="text-xs bg-pink-100 dark:bg-blue-500/20 text-pink-600 dark:text-blue-400 px-3 py-1 rounded-full w-fit">
          {proj.category}
        </span>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 flex-grow leading-6">
          {proj.desc}
        </p>
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {proj.tech.map((tech, i) => (
            <span
              key={i}
              className="text-xs
              bg-pink-100 dark:bg-white/10
              border border-pink-200 dark:border-white/10
              text-pink-700 dark:text-gray-200
        ...
        <div className="flex justify-between items-center mt-auto">
          ...
          <a
            ...
            hover:text-pink-500 dark:hover:text-blue-300
            transition"
          >
            <FaExternalLinkAlt />
            Live
